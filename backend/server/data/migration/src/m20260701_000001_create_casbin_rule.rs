...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        let insert = Query::insert()
            ...
            .values_panic(["p".into(), "888".into(), "/api/user/change_password".into(), "PUT".into()])
            .values_panic(["p".into(), "888".into(), "/api/user/logout".into(), "POST".into()])
            .values_panic(["p".into(), "888".into(), "/api/user/bind-wechat".into(), "POST".into()])
            .values_panic(["p".into(), "888".into(), "/api/dashboard/stats".into(), "GET".into()])
            ...
            // 代码生成器
            .values_panic(["p".into(), "888".into(), "/api/generator/history".into(), "POST".into()])
            .values_panic(["p".into(), "888".into(), "/api/generator/history/list".into(), "GET".into()])
            .values_panic(["p".into(), "888".into(), "/api/generator/history/:id".into(), "GET".into()])
            .values_panic(["p".into(), "888".into(), "/api/generator/history/:id".into(), "PUT".into()])
            .values_panic(["p".into(), "888".into(), "/api/generator/history/:id".into(), "DELETE".into()])
            .values_panic(["p".into(), "888".into(), "/api/generator/history/:id/meta".into(), "GET".into()])
            .values_panic(["p".into(), "888".into(), "/api/generator/rollback".into(), "POST".into()])
            .values_panic(["p".into(), "888".into(), "/api/generator/databases".into(), "GET".into()])
            .values_panic(["p".into(), "888".into(), "/api/generator/tables".into(), "GET".into()])
            .values_panic(["p".into(), "888".into(), "/api/generator/columns".into(), "GET".into()])
            .values_panic(["p".into(), "888".into(), "/api/generator/generate-from-table".into(), "POST".into()])
            // 角色8881的API权限 (普通管理员)
            .values_panic(["p".into(), "8881".into(), "/api/user/list".into(), "GET".into()])
            .values_panic(["p".into(), "8881".into(), "/api/user/info".into(), "GET".into()])
            .values_panic(["p".into(), "8881".into(), "/api/user/change_password".into(), "PUT".into()])
            .values_panic(["p".into(), "8881".into(), "/api/user/logout".into(), "POST".into()])
            .values_panic(["p".into(), "8881".into(), "/api/user/bind-wechat".into(), "POST".into()])
            .values_panic(["p".into(), "8881".into(), "/api/dashboard/stats".into(), "GET".into()])
            ...
            .values_panic(["p".into(), "9528".into(), "/api/user/change_password".into(), "PUT".into()])
            .values_panic(["p".into(), "9528".into(), "/api/user/logout".into(), "POST".into()])
            .values_panic(["p".into(), "9528".into(), "/api/user/bind-wechat".into(), "POST".into()])
            .values_panic(["p".into(), "9528".into(), "/api/dashboard/stats".into(), "GET".into()])
